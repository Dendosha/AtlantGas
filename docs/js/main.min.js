...
async function initMap() {
	...
	const { YMap, YMapDefaultSchemeLayer, YMapDefaultFeaturesLayer, YMapControls, YMapMarker } = /*#__PURE__*/ (ymaps3__WEBPACK_IMPORTED_MODULE_0___namespace_cache || (ymaps3__WEBPACK_IMPORTED_MODULE_0___namespace_cache = __webpack_require__.t(ymaps3__WEBPACK_IMPORTED_MODULE_0__, 2)));
...
pageTabs.forEach(tabs => {
	new _libs_a11y_tabs_a11yTabs_js__WEBPACK_IMPORTED_MODULE_1__["default"](tabs, {
		openTabCallback: function () {
			...
			const orderSelectList = _libs_selectlist_selectlist_js__WEBPACK_IMPORTED_MODULE_0__["default"].find(document.getElementById('order-form-selectlist'))
